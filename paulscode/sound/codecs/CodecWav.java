      ...
      if (this.myAudioInputStream == null) {
         ...
         if (myAudioFormat == null) {
            ...
            if (fileSize > 0) {
               ...
               try {
                  while((totalBytes = this.myAudioInputStream.read(fullBuffer, bytesRead, fullBuffer.length - bytesRead)) != -1 && bytesRead < fullBuffer.length) {
