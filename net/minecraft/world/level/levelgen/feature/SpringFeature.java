...
public class SpringFeature extends Feature {
   ...
   public boolean place(Level var1, Random var2, int var3, int var4, int var5) {
      if (var1.getTile(var3, var4 + 1, var5) != Tile.rock.id) {
         return false;
      } else if (var1.getTile(var3, var4 - 1, var5) != Tile.rock.id) {
         return false;
      } else if (var1.getTile(var3, var4, var5) != 0 && var1.getTile(var3, var4, var5) != Tile.rock.id) {
         return false;
      } else {
         int var6 = 0;
         if (var1.getTile(var3 - 1, var4, var5) == Tile.rock.id) {
            ++var6;
         }
         ...
         if (var1.getTile(var3, var4, var5 - 1) == Tile.rock.id) {
            ++var6;
         }
