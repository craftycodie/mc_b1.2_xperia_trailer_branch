         ...
         for(var32 = 0; var32 < 16; ++var32) {
            for(var10 = 0; var10 < 8; ++var10) {
               ...
               if (var33) {
                  ...
                  if (var10 < 4 && !var12.isSolid() && var1.getTile(var3 + var8, var4 + var10, var5 + var32) != this.tile) {
                     return false;
                  }
               }
            }
         ...
         for(var32 = 0; var32 < 16; ++var32) {
            for(var10 = 0; var10 < 8; ++var10) {
               if (var6[(var8 * 16 + var32) * 8 + var10]) {
                  var1.setTileNoUpdate(var3 + var8, var4 + var10, var5 + var32, var10 >= 4 ? 0 : this.tile);
               }
            }
         }
      }
      ...
      for(var8 = 0; var8 < 16; ++var8) {
         for(var32 = 0; var32 < 16; ++var32) {
            for(var10 = 4; var10 < 8; ++var10) {
               if (var6[(var8 * 16 + var32) * 8 + var10] && var1.getTile(var3 + var8, var4 + var10 - 1, var5 + var32) == Tile.dirt.id && var1.getBrightness(LightLayer.Sky, var3 + var8, var4 + var10, var5 + var32) > 0) {
                  var1.setTileNoUpdate(var3 + var8, var4 + var10 - 1, var5 + var32, Tile.grass.id);
               }
            }
         }
      }
            ...
            for(var32 = 0; var32 < 16; ++var32) {
               for(var10 = 0; var10 < 8; ++var10) {
                  ...
                  if (var33 && (var10 < 4 || var2.nextInt(2) != 0) && var1.getMaterial(var3 + var8, var4 + var10, var5 + var32).isSolid()) {
                     var1.setTileNoUpdate(var3 + var8, var4 + var10, var5 + var32, Tile.rock.id);
                  }
               }
            }
         }
